...
public abstract class GenericStoneBridgeData extends BridgeData {
    ...
    public GenericStoneBridgeData(String bridgeTexture, String tilingTexture) {
        ...
        sideAbutment.addTextureOverride("AbutmentDoubleTMesh", bridgeTexture);
        sideAbutment.addTextureOverride("AbutmentDoubleMesh", tilingTexture);
        ...
        sideBracing.addTextureOverride("BracingDoubleRightWMesh", bridgeTexture);
        sideBracing.addTextureOverride("BracingDoubleRightTMesh", tilingTexture);
        this.sideDoubleBracing = new Model("Data/Bridges/Stone/StoneBridge_BracingDoubleSide.wom");
        sideDoubleBracing.addTextureOverride("DoubleBracingSideWMesh", bridgeTexture);
        sideDoubleBracing.addTextureOverride("DoubleBracingSideMesh", tilingTexture);
