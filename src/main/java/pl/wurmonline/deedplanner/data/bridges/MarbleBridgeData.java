...
public class MarbleBridgeData extends BridgeData {
    ...
    protected void prepareMaterialsMap(HashMap<BridgePartType, Materials> materials, HashMap<BridgePartSide, Materials> additionalMaterials) {
        ...
        crownMaterials.put("Marble bricks", 12);
        ...
        abutmentMaterials.put("Marble bricks", 42);
        ...
        doubleAbutmentMaterials.put("Marble bricks", 62);
        ...
        bracingMaterials.put("Marble bricks", 27);
        ...
        doubleBracingMaterials.put("Marble bricks", 32);
        ...
        supportMaterials.put("Marble bricks", 92);
        ...
        floatingMaterials.put("Marble bricks", 12);
        ...
        oneWallMaterials.put("Marble bricks", 10);
        ...
        twoWallsMaterials.put("Marble bricks", 20);
