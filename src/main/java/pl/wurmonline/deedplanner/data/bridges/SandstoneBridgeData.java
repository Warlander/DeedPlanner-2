...
public class SandstoneBridgeData extends GenericStoneBridgeData {
    
    public SandstoneBridgeData() {
        super("Data/Bridges/Stone/bridgeSandstone.dds", "Data/Bridges/Stone/bridgeSandstoneTiling.dds");
    }
    ...
    protected void prepareMaterialsMap(HashMap<BridgePartType, Materials> materials, HashMap<BridgePartSide, Materials> additionalMaterials) {
        ...
        doubleAbutmentMaterials.put("Sandstone bricks", 62);
        ...
        bracingMaterials.put("Sandstone bricks", 27);
        ...
        doubleBracingMaterials.put("Sandstone bricks", 32);
        ...
        supportMaterials.put("Sandstone bricks", 92);
        ...
        extensionMaterials.put("Sandstone bricks", 30);
        ...
        floatingMaterials.put("Sandstone bricks", 12);
        ...
        oneWallMaterials.put("Sandstone bricks", 10);
        ...
        twoWallsMaterials.put("Sandstone bricks", 20);
