...
public class SlateBridgeData extends GenericStoneBridgeData {
    
    public SlateBridgeData() {
        super("Data/Bridges/Stone/bridgeSlate.dds", "Data/Bridges/Stone/bridgeSlateTiling.dds");
    }
    ...
    protected void prepareMaterialsMap(HashMap<BridgePartType, Materials> materials, HashMap<BridgePartSide, Materials> additionalMaterials) {
        ...
        doubleAbutmentMaterials.put("Slate bricks", 62);
        ...
        bracingMaterials.put("Slate bricks", 27);
        ...
        doubleBracingMaterials.put("Slate bricks", 32);
        ...
        supportMaterials.put("Slate bricks", 92);
        ...
        extensionMaterials.put("Slate bricks", 30);
        ...
        floatingMaterials.put("Slate bricks", 12);
        ...
        oneWallMaterials.put("Slate bricks", 10);
        ...
        twoWallsMaterials.put("Slate bricks", 20);
